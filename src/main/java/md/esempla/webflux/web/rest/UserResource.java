...
import md.esempla.webflux.config.Constants;
import md.esempla.webflux.domain.User;
import md.esempla.webflux.repository.UserRepository;
import md.esempla.webflux.security.AuthoritiesConstants;
import md.esempla.webflux.service.MailService;
import md.esempla.webflux.service.UserService;
import md.esempla.webflux.service.dto.AdminUserDTO;
import md.esempla.webflux.web.rest.errors.BadRequestAlertException;
import md.esempla.webflux.web.rest.errors.EmailAlreadyUsedException;
import md.esempla.webflux.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link md.esempla.webflux.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>

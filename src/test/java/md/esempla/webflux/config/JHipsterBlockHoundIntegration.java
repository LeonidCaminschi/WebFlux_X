package md.esempla.webflux.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("md.esempla.webflux.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("md.esempla.webflux.security.DomainUserDetailsService", "createSpringSecurityUser");
